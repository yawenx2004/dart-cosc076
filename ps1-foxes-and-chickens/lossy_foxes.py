from LossyFoxProblem import LossyFoxProblem
from uninformed_search import bfs_search, dfs_search, ids_search

# Create a few test.py problems:
problem331 = LossyFoxProblem((3, 3, 1, 0), 0)
problem541 = LossyFoxProblem((5, 4, 1, 0), 2)
problem551 = LossyFoxProblem((5, 5, 1, 0), 3)
